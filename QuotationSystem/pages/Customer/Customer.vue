	...
	<view class="">
		<!-- <u-index-list> -->
			...
			<!-- <view class="top">我的企业及企业联系人</view> -->
				...
				<view class="list-cell">
					<view style="height: 70rpx;width: 100%;display: flex;align-items: center;">
					  <image src="../../static/people.png" mode="aspectFill" style="height: 70rpx;width: 70rpx;margin-right: 30rpx;"></image>
					  公众号
					</view>
				</view>
				<view class="list-cell" @tap="addcustmoerr">
					<view style="height: 70rpx;width: 100%;display: flex;align-items: center;">
					  <image src="../../static/friends.png" mode="aspectFill" style="height: 70rpx;width: 70rpx;margin-right: 30rpx;"></image>
					  新的朋友
					</view>
				</view>
			<!-- </u-index-item> -->
	  ...
	  <u-index-list :index-list="filteredIndexList">
		<view v-for="(item, index) in filteredItemArr" :key="index">
		  ...
		  <u-index-item>
			...
			<!-- #endif -->
			<view class="list-cell" v-for="(cell, cellIndex) in item" :key="cellIndex" @tap="checkMessage(cell)" @longtap="deleteData(cell)">
			  <!-- {{ cell.telephone }} {{ cell.name }} -->
			  <view style="height: 70rpx;width: 100%;display: flex;align-items: center;">
				  <image :src="cell.src" mode="aspectFill" style="height: 70rpx;width: 70rpx;margin-right: 30rpx;"></image>
				  {{ cell.name }}
			  </view>
			</view>
		  </u-index-item>
	  ...
	  <view style="position: fixed;top: 611px;left: 324px;z-index: 99;" @tap="weizhi">
			<view class="addCustrom">
				<!-- @tap="addcustmoerr" -->
					...
					this.$methods.deleteCustomer(this.$store.state.BASE_URL,event.id)
						.then(isActive => {
							...
							data = data.filter(item => {  
							    ...
							    return item.name !== event.name || item.telephone !== event.telephone;  
							});   
...
<style lang="scss" scoped>
  ...
  .addCustrom{
  		display: flex;align-items: center;justify-content: center;height:70rpx;width: 100rpx;
  	}
	.nn{
		...
		.nn:active {
		  transform: scale(0.9); /* 将图片放大为原来的 1.2 倍 */
		}
</style>
